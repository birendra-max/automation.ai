                ...
                <div class="faq-item border rounded-lg shadow-md mb-4">
                    ...
                    <div class="px-6 py-4 faq-answer">
                        <div class="mb-4">
                            ...
                            <input type="text" id="email" value="" class="w-full px-4 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-teal-500" placeholder="Enter recipient email" name="emailid">
                        </div>
                        <div class="mb-4">
                            <label for="subject" class="block text-teal-600 font-medium">Subject</label>
                            <input type="text" id="subject" value="" class="w-full px-4 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-teal-500" placeholder="Enter email subject" name="subject">
                        </div>
                        ...
                        ?>
                        <button type="submit" class="save-btn px-4 py-2 mt-4 bg-teal-600 text-white rounded hover:bg-teal-700">
                            Send
                        </button>
                    </div>
                </div>
